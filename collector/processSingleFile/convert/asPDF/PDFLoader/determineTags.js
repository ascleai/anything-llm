...
function removeSpacesAndLower(text) {
  ...
  function determineTags(document) {
    const titleDict = {
        ...
        "confirmation": ["통원 확인서", "통원 중임", "통원)확인서", "퇴원 확인서", "입원 확인서", "외출 신청서", "외박 신청서", "진료 받았음을 확인합니다"],
      ...
      const wordsDict = {
        ...
        "bills": ["할인액", "현금승인번호"],
        "bills_detail": ["처방 상세내역", "세부산정내역", "세부내역서"],
        // "bills": ["본인부담", "진찰료", "할인액", "공단부담", "검사료", "총액", "금액"],
        // "bills_detail": ["본인부담", "진찰료", "공단부담", "입원처방 상세내역", "세부산정내역", "세부내역서", "검사료", "총액", "금액"],
        "confirmation": ["원무과", "진료 확인서"],
