...
function removeSpacesAndLower(text) {
  ...
  function determineTags(document) {
    const titleDict = {
        ...
        "medical_record": ["진료기록부", "응급진료기록", "퇴실기록", "KTAS", "Triage Note", "재진기록", "초진기록", "경과기록", "Progress note", "Doctor's Record", "외래처방전", "Clinical Chart", "요약기록"],
        "doctor_order": ["Doctor Order", "Doctor's Order", "ORDER SHEET", "의사지시기록", "오더일"],
        "exam_report": ["검사슬립지", "영상검사", "진단검사", "검사결과", "판독일", "판독시간", "Exam date", "판독의", "판독자", "촬영일자", "검사일", "검사명", "판독결과", "검체채취", "채취일", "검체접수", "검사시행일", "Test Result", "조직병리", "참고치", "기능결과", "기능검사", "Report for", "Reported by", "Examination Date", "영상의학 보고서", "Examining"],
        ...
        "medical_certificate": ["진단서", "17조", "9조 1항", "9조 제1항", "위와 같이 진단합니다"],
        "nurse_record": ["Nurse Record", "Nursing record", "NURSE NOTE", "간호일지"],
        "impression_report": ["진료 소견서", "소견서"],
        "hospitalization_record": ["간호정보 조사지", "환자간호력", "의식상태", "수혈력", "간호 및 교육"],
      };
      ...
      const wordsDict = {
        ...
        "bills_detail": ["입원처방 상세내역", "세부산정내역", "세부내역서"],
        "confirmation": ["원무과"],
        "medical_record": ["초진 차트", "재진 차트", "주상병", "보조상병", "Subjecive"],
